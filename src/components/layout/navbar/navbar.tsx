    ...
    <nav className="sticky top-0 z-50 flex bg-background border-b divide-x">
      <div className="flex items-center justify-between pl-6 pr-4 py-4 flex-1">
        ...
        <div className="flex gap-1">
          <LinkButton href="/articles" variant="ghost">{t('layout.navbar.articles')}</LinkButton>
          <LinkButton href="/articles/my" variant="ghost">{t('layout.navbar.my-articles')}</LinkButton>
        </div>
      </div>
